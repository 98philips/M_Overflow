...
public class GameLevel4 extends AppCompatActivity {
    ...
    public void gameover(){
        Intent i = new Intent(GameLevel4.this, GameOver.class);
        i.putExtra("level",4);
        i.putExtra("score",c);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.layout_level_4);
    ...
    public void onBackPressed() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(GameLevel4.this);
            ...
            if(n!=0){
                te = new CountDownTimer(millip,1000){
                    public void onTick(long milli){
                        ...
                        time.setText("0"+ milli / 60000 +":"+sec);
                    }
                    public void onFinish() {
                        gameover();
                    }
